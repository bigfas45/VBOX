...
import { NewReleaseRouter } from './routes/new-release';
import { MovieByIdRouter } from './routes/movie';
import { HealthRouter } from './routes/health';
import { TransactionRouter } from './routes/transaction';
import { TransactionMovieRouter } from './routes/transactionMovie';
...
app.use(MovieByIdRouter);
app.use(HealthRouter);
app.use(TransactionRouter);
app.use(TransactionMovieRouter);
